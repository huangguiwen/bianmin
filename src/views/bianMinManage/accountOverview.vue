    ...
    <div class="app-container">
        <el-form ref="form" :inline="true">
            <el-form-item label="账户ID">
                <el-input placeholder="请输入账户ID"></el-input>
            </el-form-item>
            ...
            <el-form-item label="绑定商家">
                <el-input placeholder="请输入绑定商家"></el-input>
            </el-form-item>
            ...
            <el-form-item label="今日充值金额">
                <el-col :span="11">
                    <el-input placeholder="请输入今日充值金额最小值"></el-input>
                </el-col>
                <el-col class="line" :span="2">-</el-col>
                <el-col :span="11">
                    <el-input placeholder="请输入今日充值金额最大值"></el-input>
                </el-col>
            </el-form-item>
            <el-form-item label="今日充值笔数">
                <el-col :span="11">
                    <el-input placeholder="请输入今日充值笔数最小值"></el-input>
                </el-col>
                <el-col class="line" :span="2">-</el-col>
                <el-col :span="11">
                    <el-input placeholder="请输入今日充值笔数最大值"></el-input>
                </el-col>
            </el-form-item>
            <el-form-item label="本月充值金额">
                <el-col :span="11">
                    <el-input placeholder="请输入本月充值金额最小值"></el-input>
                </el-col>
                <el-col class="line" :span="2">-</el-col>
                <el-col :span="11">
                    <el-input placeholder="请输入本月充值金额最大值"></el-input>
                </el-col>
            </el-form-item>
            <el-form-item label="本月充值笔数">
                <el-col :span="11">
                    <el-input placeholder="请输入本月充值笔数最小值"></el-input>
                </el-col>
                <el-col class="line" :span="2">-</el-col>
                <el-col :span="11">
                    <el-input placeholder="请输入本月充值笔数最大值"></el-input>
                </el-col>
            </el-form-item>
        ...
        <el-table :data="dataList">
            ...
            <el-table-column label="账号" prop="age"></el-table-column>
            ...
            <el-table-column label="历史提现" prop="history_deposit_count">
                <template slot-scope="scope">
                    <span>￥{{ scope.row.history_deposit_count | toFixed(2) }}</span>
                </template>
            </el-table-column>
            ...
            <el-table-column label="历史总额度" prop="address">
                <template slot-scope="scope">
                    <span>￥{{ scope.row.month_recharge_fee | toFixed(2) }}</span>
                </template>
            </el-table-column>
            ...
            new Promise(resolve => {
                bianMinManage.getOverViewList(this.searchForm).then(res =>{
                    if(res.code == 200) {
                        ...
                        this.searchForm.dataCount = Number.parseInt(res.data.dataCount)
                        resolve()
                    }
                })
            })
