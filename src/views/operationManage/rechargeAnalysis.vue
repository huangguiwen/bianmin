<template>
    <div class="app-container">
        <section>
            ...
            <el-date-picker v-model="dataTime" type="daterange" range-separator="至" start-placeholder="开始日期" end-placeholder="结束日期"></el-date-picker>
            <el-button type="primary" class="el-icon-search">搜索</el-button>
        </section>
        <section>
            <el-button-group>
                <el-button type="primary">充值次数</el-button>
                <el-button type="primary">充值金额</el-button>
                <el-button type="primary">到账金额</el-button>
                <el-button type="primary">待审核充值订单数量</el-button>
                <el-button type="primary">待审核充值订单总金额</el-button>
            </el-button-group>
